...
protected:
    ...
    double          CalculateCoreMassAtPhaseEnd() const                             { return CalculateCoreMassAtPhaseEnd(OPTIONS->Core_Mass_Multiplier() * m_Mass0); }                                            // Use class member variables
    double          CalculateCoreMassOnPhase(const double p_Mass, const double p_Time) const;
    double          CalculateCoreMassOnPhase() const                                { return CalculateCoreMassOnPhase(OPTIONS->Core_Mass_Multiplier() * m_Mass0, m_Age); }               // Lieke: trying to increase core mass fraction // Use class member variables
